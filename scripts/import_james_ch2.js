...
async function importJamesChapter2() {
    try {
        // Fetch James Chapter 2 from Bible API
        const response = await axios.get('https://bible-api.com/james+2:1-26?translation=web');
        ...
        // Get the chapter ID for James 2
        ...
        console.log('Successfully imported James Chapter 2');
    } catch (error) {
        console.error('Error importing James Chapter 2:', error);
        throw error;
    } finally {
        await pool.end();
    }
