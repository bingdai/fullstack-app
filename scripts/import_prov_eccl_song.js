...
const books = [
    { name: 'Proverbs', short: 'Prov', chapters: 31 },
    { name: 'Ecclesiastes', short: 'Eccl', chapters: 12 },
    { name: 'Song of Solomon', short: 'Song', chapters: 8 }
];
...
async function importBook(book) {
    ...
    for (let chapterNum = 1; chapterNum <= book.chapters; chapterNum++) {
        ...
        // Bible API expects e.g. "proverbs+1" or "song+of+solomon+1"
