...
async function importJamesChapter1() {
    try {
        // Fetch James Chapter 1 from Bible API
        const response = await axios.get('https://bible-api.com/james+1:1-27');
        ...
        console.log('Successfully imported James Chapter 1');
    } catch (error) {
        console.error('Error importing James Chapter 1:', error);
        throw error;
    } finally {
        await pool.end();
    }
