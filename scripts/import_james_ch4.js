...
async function importJamesChapter4() {
    try {
        // Fetch James Chapter 4 from Bible API
        const response = await axios.get('https://bible-api.com/james+4:1-17?translation=web');
        ...
        // Get the chapter ID for James 4
        ...
        console.log('Successfully imported James Chapter 4');
    } catch (error) {
        console.error('Error importing James Chapter 4:', error);
        throw error;
    } finally {
        await pool.end();
    }
