...
async function importJamesChapter3() {
    try {
        // Fetch James Chapter 3 from Bible API
        const response = await axios.get('https://bible-api.com/james+3:1-18?translation=web');
        ...
        // Get the chapter ID for James 3
        ...
        console.log('Successfully imported James Chapter 3');
    } catch (error) {
        console.error('Error importing James Chapter 3:', error);
        throw error;
    } finally {
        await pool.end();
    }
