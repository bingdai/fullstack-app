...
const books = [
    { name: '1 Samuel', short: '1Sam', chapters: 31 },
    { name: '2 Samuel', short: '2Sam', chapters: 24 },
    { name: '1 Kings', short: '1Kgs', chapters: 22 },
    { name: '2 Kings', short: '2Kgs', chapters: 25 },
    { name: '1 Chronicles', short: '1Chr', chapters: 29 },
    { name: '2 Chronicles', short: '2Chr', chapters: 36 },
    { name: 'Ezra', short: 'Ezra', chapters: 10 },
    { name: 'Nehemiah', short: 'Neh', chapters: 13 },
    { name: 'Esther', short: 'Esth', chapters: 10 }
];
...
async function importBook(book) {
    ...
    for (let chapterNum = 1; chapterNum <= book.chapters; chapterNum++) {
        ...
        // Bible API expects e.g. "1+samuel+1"
